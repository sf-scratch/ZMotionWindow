...
namespace cszmcaux
{
    ...
    public class Zmcaux
    {
        ...
        *************************************************************/
        ...
        /// </summary>
        /// <param name="handle">卡链接handle  </param>
        /// <param name="imaxaxises">参与运动的轴数量</param>
        /// <param name="piAxislist">参与运动的轴列表</param>
        /// <param name="distance">距离（x y z）</param>
        /// <param name="distance">弧度（x y z）</param>
        /// <returns></returns>
        ...
        /// <param name="imaxaxises">参与运动的轴数量</param>
        /// <param name="piAxislist">参与运动的轴列表</param>
        /// <param name="end">运动距离（轴0 轴1 轴2）</param>
        /// <param name="centre">弧度（轴0 轴1 轴2）</param>
        /// <param name="distance">距离（3个螺旋轴的距离）</param>
        /// <returns></returns>
        ...
        /// <param name="imaxaxises">参与运动的轴数量</param>
        /// <param name="piAxislist">参与运动的轴列表</param>
        /// <param name="end">运动距离（轴0 轴1 ）</param>
        /// <param name="centre">弧度（轴0 轴1 ）</param>
        /// <param name="distance">距离（3个螺旋轴的距离）</param>
        /// <returns></returns>
        ...
        /// <param name="imaxaxises">参与运动的轴数量</param>
        /// <param name="piAxislist">参与运动的轴列表</param>
        /// <param name="distance">距离（8个轴的距离）</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_Mover_L", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_Mover_L(IntPtr handle, int imaxaxises, int[] piAxislist, float[] distance);
        ...
        public static extern Int32 ZAux_Direct_Mover_LABS(IntPtr handle, int imaxaxises, int[] piAxislist, float[] distance);
        ...
        public static extern Int32 ZAux_World_DPos(IntPtr handle, int axis, ref float[] wdpos);
        ...
        public static extern Int32 ZAux_Frame_Rotate2(IntPtr handle, int[] piAxislist, int imaxaxises, int tablein, int tableout, int dir, float[]distance, float[]radian);
        ...
        public static extern Int32 ZAux_Direct_FrameStatus(IntPtr handle, int axis, int pfValue);
        ...
        ///  RT启停控制 
        /// </summary>
        /// <param name="handle">预留  </param>
        /// <param name="icode">1- 启动RT,  2- 停止RT.</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_LocalRTManage", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_LocalRTManage(int isel, int icode);
        ...
        /// <param name="icode">1- 启动RT,  2- 停止RT.</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetLocalRTState", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetLocalRTState(int isel, int icode);
